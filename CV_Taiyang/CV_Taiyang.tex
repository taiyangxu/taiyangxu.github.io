...
\begin{enumerate}[--]
% \item 5th ZiF Summer School ``Randomness in Physics and Mathematics: From Thermalisation in Quantum Systems to Random Matrices, Bielefeld University, Bielefeld, Germany, 25 Aug--6 Sep, 2025. \\(\uwave{Contributed talk: ``{\sl Confluent hypergeometric kernel determinant on multiple large intervals}''})
\item Universality, Nonlinearity, and Integrability, In honor of Percy Deift, Seoul, Korea, 12--16 May, 2025.
\item The 2nd Workshop on Integrable Systems and Random Matrix Theory, Dongguan, China, 5--17 Jan, 2025. \\ (\uwave{Invited talk: ``{\sl Transient asymptotics of the modified Camassa-Holm equation}''})
...
\item The 15th Hemudu Forum on Integrable Systems, Ningbo, China, 24--26 Nov, 2023. \\ (\uwave{Contributed talk: ``{\sl Integrable PDEs with nonzero boundary conditions: large-time asymptotics}''})
