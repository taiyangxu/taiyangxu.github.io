...
\begin{enumerate}[--]
%    \item 5th ZiF Summer School ``Randomness in Physics and Mathematics: From Thermalisation in Quantum Systems to Random Matrices, Bielefeld University, Bielefeld, Germany, 25 Aug-6 Sep, 2025. (Contributed talk: ``{\sl Confluent hypergeometric kernel determinant on multiple large intervals}'')
