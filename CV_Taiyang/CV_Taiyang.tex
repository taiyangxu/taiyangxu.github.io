...
\begin{enumerate}[--]
\item Bielefeld-Melbourne-Seoul Random Matrix Seminar, Online, 15th Oct, 2025. \\  {\rmfamily [Invited talk: ``{\slshape Confluent hypergeometric kernel determinant on multiple large intervals}'']}
\item 5th ZiF Summer School ``Randomness in Physics and Mathematics: From Thermalisation in Quantum Systems to Random Matrices'', Universit\"{a}t Bielefeld, Bielefeld, Germany, 25 Aug--6 Sep, 2025. \\ {\rmfamily [Contributed talk: ``{\slshape Confluent hypergeometric kernel determinant on multiple large intervals}'']}
\item Seminar @UCLouvain, Louvain-la-Neuve, Belgium, 21 Aug, 2025. \\ {\rmfamily [Invited talk: ``{\slshape An introduction to Dubrovin's universality conjecture for integrable PDEs, and some progress on the Camassa-Holm equation}'']}
\item Universality, Nonlinearity, and Integrability, In honor of Percy Deift, Seoul, Korea, 12--16 May, 2025.
\item The 2nd Workshop on Integrable Systems and Random Matrix Theory, Dongguan, China, 5--17 Jan, 2025. \\ {\rmfamily [Invited talk: ``{\slshape Transient asymptotics of the modified Camassa-Holm equation}'']}
...
\item The 15th Hemudu Forum on Integrable Systems, Ningbo, China, 24--26 Nov, 2023. \\  {\rmfamily [Contributed talk: ``{\slshape Integrable PDEs with nonzero boundary conditions: large-time asymptotics}'']}
